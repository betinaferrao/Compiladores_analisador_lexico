...
// Imprime todos os símbolos armazenados na tabela
...
void imprimir_token(Token token, int linha, int coluna) {
    const char* tipo_str;
    switch (token.tipo) {
        case TOKEN_IDENT: tipo_str = "IDENT"; break;
        case TOKEN_NUM: tipo_str = "NUM"; break;
        case TOKEN_OP_RELACIONAL: tipo_str = "OP_RELACIONAL"; break;
        case TOKEN_PALAVRA_CHAVE: tipo_str = "PALAVRA_CHAVE"; break;
        case TOKEN_ERRO: tipo_str = "ERRO"; break;
        ...
        switch (estado) {
            ...
            case 3: // OP_REL
                if (c == '=') {
                    ...
                    estado = 0;
                    idx = 0;
                } else if ((palavra[0] == '>' && c == '>') || (palavra[0] == '<' && c == '<')) {
                    palavra[1] = c;
                    palavra[2] = '\0';
                    Token token;
                    token.tipo = TOKEN_ERRO;
